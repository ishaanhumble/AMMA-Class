...
Student_dataset <- read.csv(file = "/Users/stacy/Downloads/student/student-por.csv", head=T,sep = ";")
Student_dataset_perf <- read.csv(file = "/Users/stacy/Downloads/student/student-mat.csv", head =T,sep=";")
View(Student_dataset)
View(Student_dataset_perf)
...
espn_table <-read.table(url="http://stats.espncricinfo.com/ci/content/records/284248.html",header=T,stringsAsFactors = F)
espn_table
View(espn_table)
