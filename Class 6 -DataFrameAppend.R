...
dt_missing<-data.frame(age=c(12,34,56,67,NA,45,78,NA),Income=c(12312,124124,NA,1411,14134,12412,12412,534325))
dt_missing$agemissing <- is.na(dt_missing$age)
dt_missing$Incomemissing <- is.na(dt_missing$Income)
dt_missing_non <- dt_missing[!(dt_missing$agemissing | dt_missing$Incomemissing),]
